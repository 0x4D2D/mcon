...
public class GotoCmd extends Command{
    ...
    public String call(String args[]) throws RefUtilsException{
        ...
        playerAsEntity.invokeSpecific("method_30634", new ClassObject(double.class, (double)x), new ClassObject(double.class, (double)y), new ClassObject(double.class, (double)z));
